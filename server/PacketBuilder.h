...
public:
    ...
    static std::vector<uint8_t> user_joined(uint16_t client_id, const char* username);
    static std::vector<uint8_t> user_left(uint16_t client_id);
    static std::vector<uint8_t> error(ErrorCode code);
